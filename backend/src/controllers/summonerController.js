const { getSummonerByAccountName, getSummonerByPuuid, createSummoner, updateSummonerRank, deleteSummoner } = require('../services/summonerService');
...
const createSummonerHandler = async (req, res) => {
    try {
        ...
        const newSummoner = await createSummoner({ gameName, tagLine, region, puuid, tier, rank, lp });
